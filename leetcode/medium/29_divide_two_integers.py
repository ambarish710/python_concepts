...
# Cover the Overflow usecase in the beginning
# Convert numbers to negative (bigger span) and track how many of them negative
# Approach substract the divisor from the dividend till your divisor > dividend
# And count the number of iterations == quotient...
